<?php
namespace Ayur\Pattern\AbstractFactory\Inteface;
...
class MySQLFactory implements DBMSFactory
{
  public function DBConnection() : Connection
  {
...
class PostgreSQLFactory implements DBMSFactory
{
  public function DBConnection() : Connection
  {
...
class OracleFactory implements DBMSFactory
{
  public function DBConnection() : Connection
  {
...
{
  public function useConnectionFunction() : string;
}
...
interface Record
{
  public function useRecordFunction() : string;
}
...
{
  public function useQueryBuilderFunction() : string;
}
...
function clientCode(DBMSFactory $factory)
{
  $DBConnection = $factory->DBConnection();
  $DBRecord = $factory->DBRecord();
  $DBQueryBuilder = $factory->DBQueryBuilder();

  echo $DBConnection->useConnectionFunction() . "\n"; 
  echo $DBRecord->useRecordFunction() . "\n";
  echo $DBQueryBuilder->useQueryBuilderFunction() . "\n";
}
